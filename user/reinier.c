...
#define QW18_SYM1_L1 KC_NO, KC_NO, A(KC_2), KC_NO, 		 KC_NO
#define QW18_SYM1_R1 KC_NO, KC_NO, KC_CIRC, S(KC_SLASH), KC_NO

#define QW18_SYM1_L2 KC_NO, S(KC_F19), KC_GRAVE, KC_DQUO, KC_NO
#define QW18_SYM1_R2 KC_NO, KC_HASH, KC_AT, KC_EXLM, A(KC_SCLN)

#define QW18_SYM1_L3 QW18_NO_ROW
#define QW18_SYM1_R3 QW18_NO_ROW

#define QW18_SYM1_LT KC_TRNS, KC_TRNS, KC_QUOT
...
#define QW18_SYM2_L1 KC_NO, KC_TILD, KC_BSLS, KC_PIPE, KC_NO
#define QW18_SYM2_R1 KC_NO, KC_RPRN, KC_RBRC, KC_RCBR, KC_NO

#define QW18_SYM2_L2 KC_UNDS, KC_DLR, KC_SLASH, KC_PERC, KC_NO
#define QW18_SYM2_R2 KC_NO, KC_LPRN, KC_LBRC, KC_LCBR, KC_SCLN

#define QW18_SYM2_L3 QW18_NO_ROW
#define QW18_SYM2_R3 QW18_NO_ROW

#define QW18_SYM2_LT KC_TRNS, KC_TRNS, KC_AMPR
...
#define QW18_NUM_L1 KC_NO, KC_PLUS, KC_5, KC_6, KC_NO
#define QW18_NUM_R1 KC_NO, KC_7, KC_8, KC_9, KC_NO

#define QW18_NUM_L2 KC_ASTR, KC_MINUS, KC_0, KC_1, KC_NO
#define QW18_NUM_R2 KC_NO, KC_2, KC_3, KC_4, KC_PEQL

#define QW18_NUM_L3 QW18_NO_ROW
#define QW18_NUM_R3 QW18_NO_ROW

#define QW18_NUM_LT KC_TRNS, KC_TRNS, KC_COLN
...
#define QW18_EXT_L1 KC_NO, KC_ESC, KC_PGUP, KC_F18, KC_NO
